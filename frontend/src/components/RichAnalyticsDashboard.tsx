                  ...
                  <div className="chart-svg-box" style={{ height: '240px', width: '100%' }}>
                    <ResponsiveContainer width="100%" height="100%">
                      <AreaChart data={data.contract_demand.series} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                        ...
                        <RechartsTooltip contentStyle={{ backgroundColor: 'var(--cortex-surface)', borderColor: 'var(--cortex-border)', color: 'var(--cortex-text)' }} formatter={(val: number) => [cdViewMode === 'utilisation' ? `${val}%` : `${val} kVA`, cdViewMode === 'utilisation' ? 'Utilisation' : 'Peak']} />
