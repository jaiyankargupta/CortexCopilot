...
print("--- EVALUATING BACKEND (FastAPI + Cortex Guard + Qwen2.5 Base) ---")
...
report = "# Backend Pipeline Evaluation (Base Qwen2.5 1.5B via Ollama)\n\n"
...
with open("Qwen_Backend_Results.md", "w") as f:
    f.write(report)

print("\n✅ SUCCESS! All 15 questions processed. Results saved to Qwen_Backend_Results.md")
